  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className="glass-inset text-text-muted hover:bg-inset-hover flex size-10 items-center justify-center rounded-[var(--radius)] border-border-strong sm:size-11"
      >
      ...
      <div className="relative flex-1">
        <input
          ...
          className="glass-inset text-text focus:border-accent focus:inset-ring-accent h-10 w-full rounded-[var(--radius)] border-border-strong px-2.5 text-center text-base tabular-nums focus:inset-ring-1 focus:outline-none sm:h-11 sm:px-3"
        />
        {suffix ? (
