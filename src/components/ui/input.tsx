  ...
  return (
    <input
      ...
      className={cn(
        ...
        'glass-inset text-text border-border-strong h-10 w-full rounded-[var(--radius)] px-2.5 text-base sm:h-11 sm:px-3',
...
export function Textarea({ className, ...props }: React.ComponentProps<'textarea'>) {
  return (
    <textarea
      className={cn(
        'glass-inset text-text border-border-strong min-h-18 w-full resize-y rounded-[var(--radius)] px-2.5 py-2 text-base sm:min-h-20 sm:px-3',
        'placeholder:text-text-subtle focus:border-accent focus:inset-ring-accent focus:inset-ring-1 focus:outline-none',
