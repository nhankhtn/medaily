...
export async function Header({ today, theme }: { today: ISODate; theme: ThemePreference }) {
  ...
  return (
    /*
     * Sticky root stays visually transparent. Safari 26 samples edge chrome for
     * notch / Dynamic Island “ears”; backdrop-filter or a fill on the sticky
     * node itself makes it skip tinting and leave those ears flat. Glass lives
     * on the absolute child below.
     */
    <header className="sticky top-0 z-30">
      <div
        aria-hidden
        className="glass pointer-events-none absolute inset-0 border-x-0 border-t-0"
      />
